...
/**
 * Servlet implementation class BookingListOfUserServlet
 */
@WebServlet("/BookingListOfUserServlet")
public class BookingListOfUserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Booking> eventList =bookingservice.getBookedEventDetailsByUserId(id);
